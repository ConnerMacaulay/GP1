...
void cFighter2::update(float deltaTime)
{
	...
	//	theRocketBullets.push_back(new cFist);
	...
	==============================================================
	*/
	//for (vector<cFist*>::iterator bulletIterartor = theRocketBullets.begin(); bulletIterartor != theRocketBullets.end(); ++bulletIterartor)
	//{
	...
	//vector<cFist*>::iterator bulletIterartor = theRocketBullets.begin();
